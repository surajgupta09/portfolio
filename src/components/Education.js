  ...
  return (
    <div id="education" className="container text-start">
			...
			<ul className="timeline">
				<li>
					<p className='fw-bold customText'>National Institute of Technology, Durgapur</p>
