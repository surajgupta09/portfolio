    ...
    <div id="work" className="container text-start">
		<Title title="WORK EXPERIENCES" size="1" color="secondary"/>
			<ul className="timeline">
				<li className='row'>
					<p className='fw-bold text-primary'>Software Developer, AMDOCS</p>
				...
				<li>
					<p className='fw-bold text-primary'>Web Developer Intern, Dharti Foundation <a className='fs-5' href={certificate} download='intern_certi'><FiDownload /></a></p>
